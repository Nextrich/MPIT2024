...
class MyApp(App):
	...
	def build(self):
		...
		buttons_layout.add_widget(self.addit_patience_lbl)
		...
		self.about_lbl = Label(text='О нас:', bold=True, size_hint =(.7, .4), pos =(214.0, 390.0), pos_hint ={'center_x':.5})   #, background_normal='btn_bg.png')
		self.about_text = Label(text='"Междуреченский турист" - это проект для комфортного туризма! Список достопримечательностей тайги, электронный "паспорт тайги" и многое другое!', text_size=(350, None), size_hint =(.7, .4), pos =(214.0, 325.0), pos_hint ={'center_x':.5})
